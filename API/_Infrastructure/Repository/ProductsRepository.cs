...
namespace API._Infrastructure.Repository
{
    public class ProductsRepository : IProductsRepository
    {
        ...
        {
            new Product { Id = 1, Name = "Citron", Type = ProductType.Fruit },
            new Product { Id = 2, Name = "Clémentine", Type = ProductType.Fruit },
            new Product { Id = 3, Name = "Pomelo", Type = ProductType.Fruit },
